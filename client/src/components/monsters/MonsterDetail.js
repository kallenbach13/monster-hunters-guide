...
const MonsterDetail = () => {
  ...
  return (
      <div className="flex-grow bg-black p-5">
        ...
        <div className="p-10">  
            <div className="max-w-md mx-auto rounded overflow-hidden shadow-lg bg-gray-100">
            <img className="w-full" src={monster.image_url_two} alt={monster.name} />
            <div className="px-6 py-4">
                <div className="font-bold font-serif text-red-900 text-xl text-center mb-4">{monster.name}</div>
